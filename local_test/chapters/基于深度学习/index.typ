...
第 3 章表明，颜色与指数统计优于直接展开的 RGB 像素向量，但这类统计不能完整描述冠层纹理和空间关系。本章设计轻量级双指标识别模型 RTCMNet，以学习多尺度图像特征，并满足端侧推理需求。模型通过对比、分任务评价、消融与实机测试进行验证；4.2—4.5 节依次介绍方法、数据、实验和讨论，4.6 节为小结。
